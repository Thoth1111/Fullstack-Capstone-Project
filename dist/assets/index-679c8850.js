...
function Lf(e, n) {
  if (jn)
    return e === 'compositionend' || (!ru && Is(e, n)) ? ((e = Ds()), (Sr = eu = en = null), (jn = !1), e) : null;
  switch (e) {
    case 'paste':
      return null;
    case 'keypress':
...
function mi(e, n, t) {
  ...
  t ? ((e = Js(e, n, xn)), (r.__reactInternalMemoizedMergedChildContext = e), j(fe), j(re), M(re, e)) : j(fe),
    M(fe, t);
}
var Ve = null,
  ul = !1,
    ...
    children: [
      ...
      le.jsxs('div', {
        ...
        children: [
          ...
          le.jsxs('p', { children: ['Edit ', le.jsx('code', { children: 'src/App.jsx' }), ' and save to test HMR'] }),
        ],
      }),

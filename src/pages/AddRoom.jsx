  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-screen h-screen gap-8 text-white">
      ...
      <div className="z-10 items-center justify-center hidden text-center rounded-full md:absolute lg:absolute left-40 top-52 w-80 h-80 md:flex lg:flex outline-4 outline">
        {vespaData.Url && (
          <img src={vespaData.Url} alt="Background" className="object-fill rounded-full w-80 h-80 " />
        )}
      ...
      >
        ...
        <div className="relative z-0 w-full mb-6 group">
          <input type="text" value={vespaData.Description} name="Description" id="Description" className="block py-2.5 px-0 w-full  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required onChange={handleInputChange} />
